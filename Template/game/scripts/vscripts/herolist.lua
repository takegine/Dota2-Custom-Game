...
CustomHeroList = 
{
  ...
  "npc_dota_hero_arc_warden",				-- 天穹守望者（电狗）
  ...
  "npc_dota_hero_clinkz",					-- 克林克兹（小骷髅）
  "npc_dota_hero_crystal_maiden",			-- 水晶室女
  "npc_dota_hero_dark_seer",					-- 黑暗贤者
  "npc_dota_hero_dark_willow" ,				-- 邪影芳灵（花仙子）
  ...
  "npc_dota_hero_drow_ranger",               -- 卓尔游侠（小黑）
  "npc_dota_hero_earth_spirit",              -- 大地之灵（土猫）
  "npc_dota_hero_earthshaker",               -- 撼地神牛
  "npc_dota_hero_elder_titan",               -- 上古巨神（大牛）
  "npc_dota_hero_ember_spirit",              -- 灰烬之灵（火猫）
  ...
  "npc_dota_hero_huskar",                    -- 神灵武士（哈斯卡）
  "npc_dota_hero_invoker",                   -- 祈求者（卡尔）
  "npc_dota_hero_jakiro",                    -- 双头龙
  "npc_dota_hero_juggernaut",                -- 剑圣
  "npc_dota_hero_keeper_of_the_light",       -- 光之守卫（光法）
  "npc_dota_hero_kunkka",                    -- 昆卡（船长）
  "npc_dota_hero_legion_commander",          -- 军团指挥官
  "npc_dota_hero_leshrac",                   -- 拉席克（老鹿）
  "npc_dota_hero_lich",                      -- 巫妖
  "npc_dota_hero_life_stealer",              -- 噬魂鬼（小狗）
  "npc_dota_hero_lina",                      -- 莉娜
  "npc_dota_hero_lion",                      -- 莱恩
  "npc_dota_hero_lone_druid",                -- 德鲁伊
  "npc_dota_hero_luna",                      -- 露娜
  "npc_dota_hero_lycan",                     -- 狼人
  "npc_dota_hero_magnataur",                 -- 马格纳斯（猛犸）
  "npc_dota_hero_medusa",                    -- 美杜莎
  "npc_dota_hero_meepo",                     -- 地卜师（米波）
  "npc_dota_hero_mirana",                    -- 米拉娜（月骑）
  "npc_dota_hero_morphling",                 -- 变体精灵（水人）
  "npc_dota_hero_monkey_king" ,				-- 齐天大圣
  "npc_dota_hero_naga_siren",                -- 娜迦海妖（小娜迦）
  "npc_dota_hero_necrolyte",                 -- 瘟疫法师（死灵法师）
  "npc_dota_hero_nevermore",                 -- 影魔
  "npc_dota_hero_night_stalker",             -- 暗夜魔王（夜魔）
  "npc_dota_hero_nyx_assassin",              -- 司夜刺客（小强）
  "npc_dota_hero_obsidian_destroyer",        -- 殁境神蚀者（黑鸟）
  "npc_dota_hero_ogre_magi",                 -- 食人魔魔法师（蓝胖）
  "npc_dota_hero_omniknight",                -- 全能骑士
  "npc_dota_hero_oracle",                    -- 神谕者
  "npc_dota_hero_pangolier" ,				-- 石鳞剑士（滚滚）
  "npc_dota_hero_phantom_assassin",          -- 幻影刺客（PA）
  "npc_dota_hero_phantom_lancer",            -- 幻影长矛手（猴子）
  "npc_dota_hero_phoenix",                   -- 凤凰
  "npc_dota_hero_puck",                      -- 帕克
  "npc_dota_hero_pudge",                     -- 屠夫
  "npc_dota_hero_pugna",                     -- 帕格纳（骨法）
  ...
  "npc_dota_hero_shadow_demon",              -- 暗影恶魔（毒狗）
  "npc_dota_hero_shadow_shaman",             -- 暗影萨满（小Y）
  "npc_dota_hero_shredder",                  -- 伐木机
  "npc_dota_hero_silencer",                  -- 沉默术士
  "npc_dota_hero_skeleton_king",             -- 冥魂大帝（骷髅王）
  "npc_dota_hero_skywrath_mage",             -- 天怒法师
  "npc_dota_hero_slardar",                   -- 斯拉达（大鱼人）
  "npc_dota_hero_slark",                     -- 斯拉克（小鱼人）
  "npc_dota_hero_sniper",                    -- 狙击手（火枪）
  "npc_dota_hero_spectre",                   -- 幽鬼
  "npc_dota_hero_spirit_breaker",            -- 裂魂人（白牛）
  "npc_dota_hero_storm_spirit",              -- 风暴之灵（蓝猫）
  "npc_dota_hero_sven",                      -- 斯温
  "npc_dota_hero_techies",                   -- 地精工程师（炸弹人）
  "npc_dota_hero_templar_assassin",          -- 圣堂刺客（TA）
  "npc_dota_hero_terrorblade",               -- 恐怖利刃（TB）
