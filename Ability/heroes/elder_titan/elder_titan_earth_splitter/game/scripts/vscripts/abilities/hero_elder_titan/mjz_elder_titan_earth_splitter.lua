...
if IsServer() then
	...
	function ability_class:_GetPointList()
		local ability = self
		local caster = self:GetCaster()
		local casterLoc = caster:GetAbsOrigin()
		local casterAngle = caster:GetAngles().y
	...
	function ability_class:_SpellPoint(point)
		local ability = self
		local caster = self:GetCaster()
		local casterLoc = caster:GetAbsOrigin()
		local crack_time = GetTalentSpecialValueFor(ability, "crack_time")
